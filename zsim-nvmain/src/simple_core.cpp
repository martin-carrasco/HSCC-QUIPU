...
SimpleCore::SimpleCore(FilterCache* _l1i, FilterCache* _l1d,
						BaseTlb* _itlb , BaseTlb* _dtlb , g_string& _name) :
						Core(_name),l1i(_l1i), l1d(_l1d), itlb(_itlb),
						dtlb(_dtlb),instrs(0), curCycle(0), 
						haltedCycles(0) 
{
}
